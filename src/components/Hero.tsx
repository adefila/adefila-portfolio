            ...
            >
              {slide.img ? (
                <>
                  ...
                  <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "20px 24px", background: "linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 100%)" }}>
                    ...
                    <p style={{ fontFamily: "var(--font-inter)", fontSize: 11, letterSpacing: "0.5px", color: "rgba(255,255,255,0.55)", margin: "4px 0 0" }}>{slide.meta}</p>
                  </div>
                </>
              ) : null}
            </div>
